...
model = torch.load('logs/CrackFlow/Feb14_23-11-04/model.pt')
model.cuda()
...
def compute_flow(image,target, c = 0):
    ...
    image = np.tile(image[c:c+256,c:c+256],(8,1,1))
    target = np.tile(target[c:c+256,c:c+256],(8,1,1))
...
x1 = test_data[c:c+256,c:c+256,3]/256.0
x2 = test_data[c:c+256,c:c+256,4]/256.0
