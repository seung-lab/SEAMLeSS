...
def similarity_score(bundle,
    ...
    mse = ((tgt - pred_tgt)**2)[..., crop:-crop, crop:-crop]
    if weights is not None:
...
def unsupervised_loss(smoothness_factor, smoothness_type='rig', use_defect_mask=False,
                      ...
                      tgt_defects_mse=True, positive_mse_mult=1.0):
    def compute_loss(bundle):
        loss_dict = {}
        if use_defect_mask:
        ...
        loss_dict['smoothness'] = smoothness * smoothness_factor
