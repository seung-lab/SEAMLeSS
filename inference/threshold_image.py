...
if __name__ == '__main__':
  ...
  parser.add_argument('--max_mip', type=int, default=6)
  parser.add_argument('--low_threshold', type=float, default=-0.2)
  parser.add_argument('--high_threshold', type=float, default=0.1)
  ...
  class ThresholdLol():
    ...
    def __iter__(self):
      for z in self.z_range:
        t =  a.thresholdLol(cm, src, dst, z, z, bbox, mip, low_threshold, high_threshold)
        yield from t 

  copy_range = range(args.z_start, args.z_stop)
  print('COPY STARTING SECTION OF ALL BLOCKS')
  execute(ThresholdLol, copy_range)
