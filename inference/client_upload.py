import sys
import torch
from aligner_single import Aligner, BoundingBox
...
bbox = BoundingBox(v_off[0], v_off[0]+x_size, v_off[1], v_off[1]+y_size, mip=0, max_mip=12)

stack_start = v_off[2]
a.uploat_field_to_cv(stack_start, stack_start - stack_size, bbox)
