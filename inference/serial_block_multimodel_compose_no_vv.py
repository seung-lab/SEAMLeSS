...
if __name__ == '__main__':
  ...
  copy_range = full_range[0:1]
  serial_range = full_range[1:]
  vvote_range = []
  copy_field_range = []
  broadcast_field_range = []
  ...
  serial_field = cm.create(join(args.dst_path, 'field', 'serial'),
  ...
  for block_offset in serial_range:
    ...
    for i, block_start in enumerate(block_range):
      ...
      t = a.compute_field(cm, model_path, src, dst, serial_field,
                          z, z - 1, bbox, mip, pad, src_mask_cv=src_mask_cv,
