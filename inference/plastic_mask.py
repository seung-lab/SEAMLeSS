...
if __name__ == '__main__':
  ...
  parser.add_argument("--plastic_size_threshold", type=int)
  parser.add_argument("--tissue_size_threshold", type=int)
  ...
  dst = cm.create(args.dst_path, 
                  ...
                  overwrite=True).path
  plastic_size_threshold = args.plastic_size_threshold
  tissue_size_threshold = args.tissue_size_threshold
  x_start = 0
  x_stop = 270336
  y_start = 0
  y_stop = 131072
  ...
  class PlasticMask():
    ...
    def __iter__(self):
      for z in self.z_range:
          t =  a.plastic_masker(cm, src, dst, z, z, bbox, mip, plastic_size_threshold, tissue_size_threshold)
          yield from t 

  copy_range = range(args.z_start, args.z_stop)
  print('COPY STARTING SECTION OF ALL BLOCKS')
  execute(PlasticMask, copy_range)
