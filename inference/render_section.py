...
print('Tag:', out_name)
print('Source:', source)
print('Coordinates:', (args.xs, args.ys, args.tgt_z), (args.xe, args.ye, args.src_z))
print('Mip:', mip)
print('Contrast:', should_contrast)
print('Max mip:', max_mip)
print('NG link:', ng_link(out_name, 'precomputed://' + 'gs://neuroglancer/seamless/' + model_name+'_'+out_name+'/image', source[source.rindex('/')+1:], 'precomputed://' + source, (xs+xe)//2, (ys+ye)//2, tgt_z))
