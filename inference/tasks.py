...
class MaskLogicTask(RegisteredTask):
  def __init__(self, cv_list, dst_cv, z_list, dst_z, bbox, mip_list, dst_mip, op, threshold=None):
    super(). __init__(cv_list, dst_cv, z_list, dst_z, bbox, mip_list, dst_mip, op, threshold)
  ...
  def execute(self, aligner):
    ...
    if op == 'and':
      ...
      res = aligner.mask_threshold_chunk(
              threshold, op, cv_list, z_list, patch_bbox, mip_list, dst_mip)
