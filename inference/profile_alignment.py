...
# 
  ...
  s = time()
  image = a.get_image(src, serial_range[0],bbox_lookup[serial_range[0]], mip,
                      to_tensor=False, normalizer=None)
  e = time()
  #image = a.get_image(src, serial_range[1],bbox_lookup[serial_range[0]], mip,
  #                    to_tensor=False, normalizer=None)
  print("loading image time", e - s, "image size", image.nbytes, "dtype",
        image.dtype)
