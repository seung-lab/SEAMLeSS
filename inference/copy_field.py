...
if __name__ == '__main__':
  ...
  cm = CloudManager(args.src_path+"image", max_mip, pad, provenance, batch_size=1,
  ...
  src_vote = cm.create(args.src_path+"field/vvote_5", data_type='int16', num_channels=2,
                        fill_missing=True, overwrite=False)
  vvote_field0 = cm.create(join(args.dst_path, 'field', 'vvote'),
                          data_type='int16', num_channels=2,
                          fill_missing=True, overwrite=True)
  vvote_field1 = cm.create(join(args.dst_path, 'field', 'vvote_uncompress'),
...
#      #image_list, chunk = 
#      a.get_section_field(src, block_start, copy_range[0],
