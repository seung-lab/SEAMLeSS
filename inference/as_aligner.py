...
#          image_chunk = image_list[i][..., pad+head_crop:-(pad+end_crop), pad:-pad]
  ...
  def load_part_image(self, image_cv, z, bbox, image_mip, mask_cv=None,
      ...
      image = yield from self.get_image(image_cv, z, bbox, image_mip,
                             to_tensor=to_tensor, normalizer=None,
                             to_float=False)
      if mask_cv is not None:
        mask = yield from self.get_mask(mask_cv, image_z, bbox,
                             src_mip=mask_mip,
  ...
  def get_image(self, cv, z, bbox, mip, to_tensor=True, normalizer=None,
    ...
    start = time()
    image = yield from self.get_data(cv, z, bbox, src_mip=mip, dst_mip=mip,
  ...
  def get_data(self, cv, z, bbox, src_mip, dst_mip, to_float=True, 
    ...
    data = yield from cv[src_mip][x_range[0]:x_range[1], y_range[0]:y_range[1], z]
